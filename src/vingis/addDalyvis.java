...
String sqlrequest = "select metai,vardas,pavarde,gimimo_data,el_pastas,gimtasis_miestas from dalyvis where Zanras = 'S' "+aktyvumoCheck+" "+Status.Lytis+"  order by metai desc, vardas asc, pavarde asc";
